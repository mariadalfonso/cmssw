...
#         'file:/afs/cern.ch/work/d/dalfonso/HGCnose/CMSSW_11_0_0_pre3/src//Photon_E100_Step3.root'
#        'file:Gamma_E100_Step3.root'
#        'file:Gluon_E100_Step3.root'
        'file:/tmp/dalfonso/Photon_E100_Step3.root'
...
#process.TFileService = cms.Service('TFileService', fileName = cms.string('test_Gluon_ev10.root'))
#process.TFileService = cms.Service('TFileService', fileName = cms.string('test_Quark.root'))
process.TFileService = cms.Service('TFileService', fileName = cms.string('test_Photon100.root'))
