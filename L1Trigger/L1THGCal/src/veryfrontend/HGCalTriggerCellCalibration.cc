...
void HGCalTriggerCellCalibration::calibrateInMipT(
    l1t::HGCalTriggerCell& trgCell) {
...
void HGCalTriggerCellCalibration::calibrateMipTinGeV(
    l1t::HGCalTriggerCell& trgCell) {
  ...
  */
  ...
  math::PtEtaPhiMLorentzVector calibP4(trgCellEt, trgCell.eta(), trgCell.phi(),
                                       0.);
...
void HGCalTriggerCellCalibration::calibrateInGeV(
    l1t::HGCalTriggerCell& trgCell) {
