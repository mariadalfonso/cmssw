...
_hfnose_hgcalTriggerPrimitivesTask.add(hgcalVFEHFNose, hgcalConcentratorHFNose, hgcalBackEndLayer1HFNose, hgcalBackEndLayer2HFNose, hgcalTowerMapHFNose, hgcalTowerHFNose)
