...
def synchornizeHCALHLTofflineRun3on2018data(process):
...
def synchornizeHCALHLTofflineRun2(process):
...
def customizeHLTforCMSSW(process, menuType="GRun"):
    ...
    if hasattr(process,'hltHbhePhase1Reco'):
        process = synchornizeHCALHLTofflineRun2(process)
        return process

    if hasattr(process,'hltHbhereco'):
        process = synchornizeHCALHLTofflineRun3on2018data(process)
        return process
