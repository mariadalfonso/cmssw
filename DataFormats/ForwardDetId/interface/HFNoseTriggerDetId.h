...
public:
  ...
  HFNoseTriggerDetId(int subdet, int zp, int type, int layer, 
  ...
  bool isHSilicon() const { return (layer() > kHFNoseLayerEEmax); }
  ...
  // those last two not sure
  static const int kHFNoseSubdetOffset     = 25;
  static const int kHFNoseSubdetMask       = 0x4;
};
