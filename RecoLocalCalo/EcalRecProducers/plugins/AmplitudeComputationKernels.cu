...
#pragma unroll
	...
	reinterpret_cast<DataType*>(shrmem) + calo::multifit::MapSymM<DataType, NPULSES>::total * (threadIdx.x + blockDim.x);
...
#pragma unroll
    ...
    namespace v1 {
	  ...
	  2 * threads_min * calo::multifit::MapSymM<DataType, SampleVector::RowsAtCompileTime>::total * sizeof(DataType);
