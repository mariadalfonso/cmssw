...
class MahiFit
{
 public:
  ...
  __device__
    void doFit(float correctedOutput[3], const int nbx, float*, float*, float*, float*, float*, float*) const;
...
//  const HcalTimeSlew* hcalTimeSlewDelay_=nullptr;
 ...
 private:
  ...
  __device__
  const float minimize(SamplePulseMatrixMAP & pulseMat_, SampleMatrixMAP const * pulseCovArray) const;
  __device__
  void onePulseMinimize(SamplePulseMatrixMAP & pulseMat_) const;
  __device__
    //  void updateCov(SampleMatrix covInput, SampleMatrixMAP const * pulseCovArray) const;
  void updateCov(SampleMatrixMAP const * pulseCovArray) const;
  __device__
  void updatePulseShape(const float itQ, FullSampleVector &pulseShape,
  ...
  __device__
  float calculateChiSq(SamplePulseMatrixMAP & pulseMat_) const;
  __device__
