...
struct DeviceData {
  ...
  //    HcalCalibrations        *vcalibs;
    ...
    float                   *pulseMn;
    float                   *pulsePn;
    float                   *pulseShapeArray;
    float                   *pulseDerivArray;
    float                   *pulseCovArray;
	...
	cudaMalloc((void**)&pulseShapeArray, size * MaxSVSize * MaxPVSize * sizeof(float));
	cudaMalloc((void**)&pulseDerivArray, size * MaxSVSize * MaxPVSize * sizeof(float));
	cudaMalloc((void**)&pulseCovArray, size * MaxSVSize * MaxSVSize * MaxPVSize * sizeof(float));
