...
class SimpleHcalNtuplizer : public edm::EDAnalyzer {

 public:
  explicit SimpleHcalNtuplizer(const edm::ParameterSet&);
  ...
  bool matchClusterToGenParticle(const reco::PFCluster& );
 ...
 private:
  ...
  std::vector<Float_t> clusterHits_c;
  ...
  Float_t corrEnergy74X_c;
  Float_t corrEnergy74XError_c;
